...
![Loading concept](asset/concept.png "Concept of AI Scientists")
...
| [Autonomous LLM-Driven Research — from Data to Human-Verifiable Research Papers **(data-to-paper)**](https://arxiv.org/abs/2404.17605) | NEJM AI 2025 | [![Star](https://img.shields.io/github/stars/Technion-Kishony-lab/data-to-paper.svg?style=social&label=Star)](https://github.com/Technion-Kishony-lab/data-to-paper) |
...
| Title                                                        | Pub.&Date           | Code/Project URL                                             |
| ------------------------------------------------------------ | ------------------- | ------------------------------------------------------------ |
| **[REFUTE: Scientific Critique & Epistemic Calibration Benchmark](https://huggingface.co/datasets/BGPT-OFFICIAL/refute)** | Hugging Face 2026 | [![Star](https://img.shields.io/github/stars/BGPT-OFFICIAL/refute.svg?style=social&label=Star)](https://huggingface.co/datasets/BGPT-OFFICIAL/refute) |
...
| [Marg: Multi-agent review generation for scientific papers  **(MARG)**](https://arxiv.org/abs/2401.04259) | arxiv 2024 | [![Star](https://img.shields.io/github/stars/allenai/marg-reviewer.svg?style=social&label=Star)](https://github.com/allenai/marg-reviewer) |
| [Automated Focused Feedback Generation for Scientific Writing Assistance](https://arxiv.org/abs/2405.20477) | ACL 2024 | [![Star](https://img.shields.io/github/stars/ericchamoun/FocusedFeedbackGeneration.svg?style=social&label=Star)](https://github.com/ericchamoun/FocusedFeedbackGeneration) |
| [Peer Review as A Multi-Turn and Long-Context Dialogue with Role-Based Interactions  **(ReviewMT)**](https://arxiv.org/abs/2406.05688) | arxiv 2024 | [![Star](https://img.shields.io/github/stars/chengtan9907/ReviewMT.svg?style=social&label=Star)](https://github.com/chengtan9907/ReviewMT) |
| [PRE: A Peer Review Based Large Language Model Evaluator  **(PRE)**](https://arxiv.org/abs/2401.15641) | arxiv 2024 | [![Star](https://img.shields.io/github/stars/THUIR/LLM_Eval.svg?style=social&label=Star)](https://github.com/THUIR/LLM_Eval) |
...
| [AgentReview: Exploring peer review dynamics with LLM agents  **(AgentReview)**](https://arxiv.org/abs/2406.12708) | EMNLP 2024 | [![Star](https://img.shields.io/github/stars/Ahren09/AgentReview.svg?style=social&label=Star)](https://github.com/Ahren09/AgentReview) |
| [CycleResearcher: Improving Automated Research via Automated Review  **(CycleResearcher)**](https://arxiv.org/abs/2411.00816) | ICLR 2025 | [![Star](https://img.shields.io/github/stars/zhu-minjun/Researcher.svg?style=social&label=Star)](https://github.com/zhu-minjun/Researcher) |
| [The AI Scientist: Towards Fully Automated Open-Ended Scientific Discovery  **(AI Scientist)**](https://arxiv.org/abs/2408.06292) | arxiv 2024 | [![Star](https://img.shields.io/github/stars/SakanaAI/AI-Scientist.svg?style=social&label=Star)](https://github.com/SakanaAI/AI-Scientist) |
| [The AI Scientist-v2: Workshop-Level Automated Scientific Discovery via Agentic Tree Search  **(AI Scientist-v2)**](https://arxiv.org/abs/2504.08066) | arxiv 2025 | [![Star](https://img.shields.io/github/stars/SakanaAI/AI-Scientist-v2.svg?style=social&label=Star)](https://github.com/SakanaAI/AI-Scientist-v2) |

## Human-AI Scientist Collaboration
![Human-AI Scientist Collaboration](asset/human_AI.jpg "The spectrum of Human-AI interaction paradigms.")
### Human-in-the-Loop
| Title                                                        | Pub.&Date           | Code/Project URL                                             |
| ------------------------------------------------------------ | ------------------- | ------------------------------------------------------------ |
...
![Physical Science](asset/domain_physics.jpg "Three Fundamental Challenges to a Paradigm-Shifting Breakthrough for AI in Physical Science.")
### Physical Science
| Title                                                        | Pub.&Date           | Code/Project URL                                             |
| ------------------------------------------------------------ | ------------------- | ------------------------------------------------------------ |
...
### Life Science
![Life Science](asset/domain_life_science.png "Life Sciences: From Single Tasks to Fully Automated Systems and Interdisciplinary Multi-Agent Collaboration.")
| Title                                                        | Pub.&Date           | Code/Project URL                                             |
| ------------------------------------------------------------ | ------------------- | ------------------------------------------------------------ |
...
### Social Science
![Social Science](asset/domain_social.jpg "AI scientists help accelerate all stages of social science research.")
| Title | Pub.&Date | Code/Project URL |
| :--- | :--- | :--- |
...
### Data Science
![Data Science](asset/domain_data.jpg "The capabilities and categories of AI data scientists.")
| Title                                                        | Pub.&Date           | Code/Project URL                                             |
| ------------------------------------------------------------ | ------------------- | ------------------------------------------------------------ |
...
| [Data Interpreter: An LLM Agent For Data Science  **(Data Interpreter)**](https://aclanthology.org/2025.findings-acl.1016/) | ACL 2025（Findings）             | [![Website](https://img.shields.io/badge/Website-9cf?style=social)](https://docs.deepwisdom.ai/main/en/guide/use_cases/agent/interpreter/intro.html) |
...
| [AI–AI bias: Large language models favor communications generated by large language models **(AI–AI Bias)**](https://www.pnas.org/doi/10.1073/pnas.2415697122) | PNAS 2025 | [![GitHub Repo stars](https://img.shields.io/github/stars/lauritowal/ai-ai-bias?style=social)](https://github.com/lauritowal/ai-ai-bias) |
